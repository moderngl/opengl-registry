...
project = 'opengl-api-registry-reader'
...
htmlhelp_basename = 'opengl-api-registry-readerdoc'
...
latex_documents = [
    (master_doc, 'opengl-api-registry-reader.tex', 'opengl-api-registry-reader Documentation',
